...
The code snippet below shows sample code which stores sensitive data using `flutter_secure_storage`.
...
```sh
adb shell cat /data/data/org.owasp.mastestapp/shared_prefs/FlutterSecureStorage.xml
```
